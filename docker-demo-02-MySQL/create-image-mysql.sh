...
docker run --name "$containername" -v "$PWD/$mysqldatafilename":/var/lib/mysql -p 55001:3306 -e MYSQL_ALLOW_EMPTY_PASSWORD=yes -d mysql:5.6.43 --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci
